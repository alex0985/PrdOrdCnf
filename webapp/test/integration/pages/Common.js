sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("alwe/ProdOrderConf/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#ProductionOrderConfirmation-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#ProductionOrderConfirmation-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("alwe.ProdOrderConf.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["alwe/ProdOrderConf/localService/mockserver"], function (mockserver) {

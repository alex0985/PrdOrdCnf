sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("alwe.ProdOrderConf.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias alwe.ProdOrderConf.controller.ListSelector
			 */
			 ...
			 * @return {alwe.ProdOrderConf.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
